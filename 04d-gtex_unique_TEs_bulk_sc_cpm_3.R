...
################################################################################
################################################################################
#################  GTEx: Common TEs in Bulk and SC Using CPM > 3  ##############
...
pdf("plots/04d-bulk_sc_venn_cpm_0.5.pdf", height=4, width=5)
...
# Upset plot for bulk
pdf("plots/04d-bulk_tissue_upset_cpm_0.5.pdf", height=4, width=7)
...
pdf("plots/04d-sc_tissue_upset_cpm_0.5.pdf", height=4, width=7)
...
pdf("plots/04d-te_families_bulk_sc_cpm_0.5.pdf", height=8, width=5)
...
pdf("plots/04d-violin_bulk_sc_cpm_0.5.pdf", height=3, width=4)
...
pdf("plots/04d-violin_bulk_sc_tissue_cpm_0.5.pdf", height=3, width=5)
...
pdf("plots/04d-violin_tissue_bulk_sc_cpm_0.5.pdf", height=3, width=5)
...
pdf("plots/04d-tissue_venns_cpm_0.5.pdf", height=4, width=7.6)
...
pdf("plots/04d-te_families_heart_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Heart_bulk, Heart_sc, "Heart")
dev.off()

pdf("plots/04d-te_families_lung_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Lung_bulk, Lung_sc, "Lung")
dev.off()

pdf("plots/04d-te_families_e_muscularis_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(E_Muscularis_bulk, E_Muscularis_sc, "E. muscolaris")
dev.off()

pdf("plots/04d-te_families_e_mucosa_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(E_Mucosa_bulk, E_Mucosa_sc, "E. mucosa")
dev.off()

pdf("plots/04d-te_families_prostate_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Prostate_bulk, Prostate_sc, "Prostate")
dev.off()

pdf("plots/04d-te_families_breast_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Breast_bulk, Breast_sc, "Breast")
dev.off()

pdf("plots/04d-te_families_skin_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Skin_bulk, Skin_sc, "Skin")
dev.off()

pdf("plots/04d-te_families_sk_muscle_bulk_sc_cpm_0.5.pdf", height=8, width=5)
...
save(Heart_bulk_only, Heart_sc_only, Heart_both,
     file="r_outputs/04d-heart_unique_shared_te_cpm_0.5.RData")

save(Prostate_bulk_only, Prostate_sc_only, Prostate_both,
     file="r_outputs/04d-prostate_unique_shared_te_cpm_0.5.RData")
