...
################################################################################
################################################################################
###############  GTEx: Common HERVs in Bulk and SC Using CPM > 3  ##############
...
pdf("plots/04e-bulk_sc_herv_venn_cpm_0.5.pdf", height=4, width=5)
...
# Upset plot for bulk
pdf("plots/04e-bulk_tissue_herv_upset_cpm_0.5.pdf", height=4, width=7)
upset(tissue_cpm_bulk, tissues, name='Shared and Unique HERVs Per Tissue Type in Bulk',
      intersections = list( 
      ...
      set_sizes=(
        upset_set_size()
        + ylab('Total HERVs Per Tissue') ))

dev.off()

pdf("plots/04e-sc_tissue_herv_upset_cpm_0.5.pdf", height=4, width=7)
# Upset for single cell
upset(tissue_cpm_sc, tissues, name='Shared and Unique HERVs Per Tissue Type in Single Cell',
      intersections = list( 
        c("Heart","Sk_muscle", "Skin", "E_Mucosa",
          "E_Muscularis", "Prostate", "Breast", "Lung"), 
        c("Heart"), 
...
pdf("plots/04e-herv_families_bulk_sc_cpm_0.5.pdf", height=8, width=5)
...
pdf("plots/04e-violin_bulk_herv_sc_cpm_0.5.pdf", height=3, width=4)
ggplot(long_cpm, aes(type, value, fill=type)) +
  ...
  ylab("HERV Expression") + 
  theme(legend.position = c("None"))
dev.off()

pdf("plots/04e-violin_bulk_sc_herv_tissue_cpm_0.5.pdf", height=3, width=5)
...
pdf("plots/04e-violin_tissue_bulk_sc_herv_cpm_0.5.pdf", height=3, width=5)
...
pdf("plots/04e-tissue_venns_hervs_cpm_0.5.pdf", height=4, width=7.6)
...
pdf("plots/04e-herv_families_heart_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Heart_bulk, Heart_sc, "Heart")
dev.off()

pdf("plots/04e-herv_families_lung_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Lung_bulk, Lung_sc, "Lung")
dev.off()

pdf("plots/04e-herv_families_e_muscularis_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(E_Muscularis_bulk, E_Muscularis_sc, "E. muscolaris")
dev.off()

pdf("plots/04e-herv_families_e_mucosa_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(E_Mucosa_bulk, E_Mucosa_sc, "E. mucosa")
dev.off()

pdf("plots/04e-herv_families_prostate_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Prostate_bulk, Prostate_sc, "Prostate")
dev.off()

pdf("plots/04e-herv_families_breast_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Breast_bulk, Breast_sc, "Breast")
dev.off()

pdf("plots/04e-herv_families_skin_bulk_sc_cpm_0.5.pdf", height=8, width=5)
shared_unique_tissues(Skin_bulk, Skin_sc, "Skin")
dev.off()

pdf("plots/04e-herv_families_sk_muscle_bulk_sc_cpm_0.5.pdf", height=8, width=5)
